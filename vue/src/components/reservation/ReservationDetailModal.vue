  ...
  ><div
    ...
    >     <div class="border-b border-gray-200 p-6 sticky top-0 bg-white z-10 rounded-t-2xl">
        <div class="flex items-start justify-between">
          <div class="flex-1">
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Tú reserva en {{ reservation.portName }}</h2>
        ...
        <div class="space-y-6">
          <div class="border border-gray-200 rounded-xl p-5" v-if="reservation.mooringName">
            <div class="flex items-center gap-3 text-gray-600 mb-1">
              ...
              <div class="text-xs uppercase tracking-wide font-semibold">Zona</div>
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="border border-gray-200 rounded-xl p-5">
              <div class="flex items-center gap-3 text-principal-blue mb-1">
                ...
                <div class="text-xs uppercase tracking-wide font-semibold">Embarcación</div>
              </div>
            ...
            <div class="border border-gray-200 rounded-xl p-5">
              <div class="flex items-center gap-3 text-principal-blue mb-1">
                ...
                <div class="text-xs uppercase tracking-wide font-semibold">Amarre</div>
              </div>
          ...
          <div class="border border-gray-200 rounded-xl p-5">
            <div class="flex items-center gap-3 text-principal-blue mb-4">
              ...
              <div class="text-xs uppercase tracking-wide font-semibold">Periodo de estancia</div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 ml-7">
              <div>
                <div class="text-xs text-principal-blue mb-1 uppercase tracking-wide">Check-in</div>
                <div class="font-semibold text-gray-900 text-lg">
                  {{ formatDate(reservation.startDate) }}
                </div>
              </div>
              <div>
                <div class="text-xs text-principal-blue mb-1 uppercase tracking-wide">Check-out</div>
                <div class="font-semibold text-gray-900 text-lg">
          ...
          <div class="border border-gray-200 rounded-xl p-5">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3 text-principal-blue">
                ...
                <div class="text-xs uppercase tracking-wide font-semibold">Coste total</div>
              </div>
